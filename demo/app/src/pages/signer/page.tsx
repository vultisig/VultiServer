  ...
  return (
    <>
      <section className="h-[70vh] flex justify-center items-center">
          ...
          <AnimatePresence mode="wait">
            <>
              <div className="mx-auto w-full mt-5 rounded-xl bg-[#061B3A] max-w-screen-xl px-4 py-6 lg:py-20 flex justify-between overflow-hidden">
                <div className="lg:w-[80%] w-full flex flex-wrap justify-center lg:justify-between mx-24">
                  <img
                  ...
                  <div className="flex flex-col items-start justify-center flex-wrap">
                    ...
                    {currentStep === 2 && (
                      <StepTwo
                        ...
                        goToStep={goToStep}
                        setQrCodeString={setQrCodeString}
                      />
                    )}
                  </div>
                </div>
        ...
        {currentStep === 4 && (
          <StepFour session_id={session_id} devices={uniqueStrings} />
        )}
      </section>
    </>
  );
